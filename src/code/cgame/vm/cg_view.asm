...
;1561:	{
line 1562
;1562:		if (cg_fpls.integer && cg.predictedPlayerState.weapon == WP_SABER)
ADDRGP4 cg_fpls+12
INDIRI4
CNSTI4 0
EQI4 $1141
...
NEI4 $1141
line 1563
;1563:		{ //force to first person for fpls
line 1564
;1564:			cg.renderingThirdPerson = 0;
ADDRGP4 cg+88
CNSTI4 0
ASGNI4
line 1565
...
;1567:		{
line 1568
;1568:			cg.renderingThirdPerson = 1;
ADDRGP4 cg+88
CNSTI4 1
ASGNI4
line 1569
...
LABELV $1127
line 1571
;1571:	else if (cg.snap->ps.zoomMode)
ADDRGP4 cg+36
INDIRP4
CNSTI4 1376
ADDP4
...
EQI4 $1148
line 1572
;1572:	{ //always force first person when zoomed
line 1573
;1573:		cg.renderingThirdPerson = 0;
ADDRGP4 cg+88
CNSTI4 0
ASGNI4
line 1574
...
line 1577
;1575:
;1576:	// build cg.refdef
;1577:	inwater = CG_CalcViewValues();
ADDRLP4 20
...
line 1579
;1578:
;1579:	CG_CalcScreenEffects();
ADDRGP4 CG_CalcScreenEffects
CALLV
pop
line 1582
;1580:
;1581:	// first person blend blobs, done after AnglesToAxis
;1582:	if ( !cg.renderingThirdPerson ) {
ADDRGP4 cg+88
INDIRI4
CNSTI4 0
NEI4 $1152
line 1583
;1583:		CG_DamageBlendBlob();
...
line 1587
;1585:
;1586:	// build the render lists
;1587:	if ( !cg.hyperspace ) {
ADDRGP4 cg+92
INDIRI4
CNSTI4 0
NEI4 $1155
line 1588
;1588:		CG_AddPacketEntities();			// adter calcViewValues, so predicted player state is correct
...
pop
line 1590
;1590:		CG_AddParticles ();
ADDRGP4 CG_AddParticles
CALLV
pop
line 1591
;1591:		CG_AddLocalEntities();
...
LABELV $1155
line 1593
;1593:	CG_AddViewWeapon( &cg.predictedPlayerState );
ADDRGP4 cg+96
ARGP4
...
;1596:	{
line 1597
;1597:		trap_FX_AddScheduledEffects();
...
line 1601
;1599:
;1600:	// add buffered sounds
;1601:	CG_PlayBufferedSounds();
ADDRGP4 CG_PlayBufferedSounds
CALLV
pop
line 1604
;1602:
;1603:	// play buffered voice chats
;1604:	CG_PlayBufferedVoiceChats();
ADDRGP4 CG_PlayBufferedVoiceChats
CALLV
pop
line 1607
;1605:
;1606:	// finish up the rest of the refdef
;1607:	if ( cg.testModelEntity.hModel ) {
ADDRGP4 cg+13484+8
INDIRI4
CNSTI4 0
EQI4 $1162
line 1608
;1608:		CG_AddTestModel();
...
LABELV $1162
line 1610
;1610:	cg.refdef.time = cg.time;
ADDRGP4 cg+3616+72
ADDRGP4 cg+64
INDIRI4
ASGNI4
line 1611
;1611:	memcpy( cg.refdef.areamask, cg.snap->areamask, sizeof( cg.refdef.areamask ) );
ADDRGP4 cg+3616+80
ARGP4
ADDRGP4 cg+36
INDIRP4
...
line 1614
;1612:
;1613:	// warning sounds when powerup is wearing off
;1614:	CG_PowerupTimerSounds();
ADDRGP4 CG_PowerupTimerSounds
CALLV
pop
line 1617
;1615:
;1616:	// if there are any entities flagged as sound trackers and attached to other entities, update their sound pos
;1617:	CG_UpdateSoundTrackers();
ADDRGP4 CG_UpdateSoundTrackers
CALLV
pop
line 1619
;1618:
;1619:	if (gCGHasFallVector)
ADDRGP4 gCGHasFallVector
INDIRI4
CNSTI4 0
EQI4 $1174
...
;1621:		vec3_t lookAng;
;1622:
;1623:		VectorSubtract(cg.snap->ps.origin, cg.refdef.vieworg, lookAng);
ADDRLP4 24
ADDRGP4 cg+36
INDIRP4
CNSTI4 64
...
pop
line 1625
;1625:		vectoangles(lookAng, lookAng);
ADDRLP4 24
ARGP4
ADDRLP4 24
ARGP4
...
line 1627
;1626:
;1627:		VectorCopy(gCGFallVector, cg.refdef.vieworg);
ADDRGP4 cg+3616+24
ADDRGP4 gCGFallVector
INDIRB
ASGNB 12
line 1628
;1628:		AnglesToAxis(lookAng, cg.refdef.viewaxis);
ADDRLP4 24
ARGP4
ADDRGP4 cg+3616+36
ARGP4
...
line 1632
;1630:
;1631:	// update audio positions
;1632:	trap_S_Respatialize( cg.snap->ps.clientNum, cg.refdef.vieworg, cg.refdef.viewaxis, inwater );
ADDRGP4 cg+36
INDIRP4
CNSTI4 188
ADDP4
...
line 1635
;1633:
;1634:	// make sure the lagometerSample and frame timing isn't done twice when in stereo
;1635:	if ( stereoView != STEREO_RIGHT ) {
ADDRFP4 4
INDIRI4
CNSTI4 2
EQI4 $1198
line 1636
;1636:		cg.frametime = cg.time - cg.oldTime;
ADDRGP4 cg+60
ADDRGP4 cg+64
INDIRI4
ADDRGP4 cg+68
...
LABELV $1203
line 1640
;1640:		cg.oldTime = cg.time;
ADDRGP4 cg+68
ADDRGP4 cg+64
INDIRI4
ASGNI4
line 1641
;1641:		CG_AddLagometerFrameInfo();
...
LABELV $1198
line 1643
;1643:	if (cg_timescale.value != cg_timescaleFadeEnd.value) {
...
GEF4 $1213
line 1645
;1645:			cg_timescale.value += cg_timescaleFadeSpeed.value * ((float)cg.frametime) / 1000;
ADDRLP4 24
ADDRGP4 cg_timescale+8
ASGNP4
ADDRLP4 24
...
LEF4 $1214
line 1647
;1647:				cg_timescale.value = cg_timescaleFadeEnd.value;
ADDRGP4 cg_timescale+8
ADDRGP4 cg_timescaleFadeEnd+8
INDIRF4
ASGNF4
...
;1649:		else {
line 1650
;1650:			cg_timescale.value -= cg_timescaleFadeSpeed.value * ((float)cg.frametime) / 1000;
ADDRLP4 24
ADDRGP4 cg_timescale+8
ASGNP4
ADDRLP4 24
...
ASGNF4
line 1651
;1651:			if (cg_timescale.value < cg_timescaleFadeEnd.value)
ADDRGP4 cg_timescale+8
INDIRF4
ADDRGP4 cg_timescaleFadeEnd+8
INDIRF4
GEF4 $1229
line 1652
;1652:				cg_timescale.value = cg_timescaleFadeEnd.value;
ADDRGP4 cg_timescale+8
ADDRGP4 cg_timescaleFadeEnd+8
INDIRF4
ASGNF4
...
LABELV $1214
line 1654
;1654:		if (cg_timescaleFadeSpeed.value) {
ADDRGP4 cg_timescaleFadeSpeed+8
INDIRF4
CNSTF4 0
EQF4 $1235
line 1655
;1655:			trap_Cvar_Set("timescale", va("%f", cg_timescale.value));
ADDRGP4 $1043
ARGP4
ADDRGP4 cg_timescale+8
INDIRF4
...
line 1660
;1658:
;1659:	// actually issue the rendering calls
;1660:	CG_DrawActive( stereoView );
ADDRFP4 4
INDIRI4
ARGI4
...
line 1662
;1661:
;1662:	if ( cg_stats.integer ) {
ADDRGP4 cg_stats+12
INDIRI4
CNSTI4 0
EQI4 $1240
line 1663
;1663:		CG_Printf( "cg.clientFrame:%i\n", cg.clientFrame );
ADDRGP4 $1243
ARGP4
ADDRGP4 cg
INDIRI4
